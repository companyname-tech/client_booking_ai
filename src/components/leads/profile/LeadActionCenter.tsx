  ...
  return (
    <div className="rounded-lg border border-line bg-surface-1 p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <Button variant="secondary" size="sm" onClick={() => onAction('call')}>Call</Button>
        <Button variant="ghost" size="sm" onClick={() => onAction('email')}>Email</Button>
        ...
        <Link to={`/client/campaigns/${lead.offerCampaignId}`}><Button variant="ghost" size="sm">Open campaign</Button></Link>
      </div>
    </div>
  )
}
